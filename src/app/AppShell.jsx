      ...
      <main className="shell-main">
        <header className="shell-topbar">
          ...
          <div className="shell-topbar-actions">
            ...
            <button className="shell-ghost-btn" type="button">Alerts</button>
            <button className="shell-ghost-btn" type="button">Export</button>
            <button className="shell-brand-btn" type="button">New</button>
          </div>
        </header>
        ...
        <section className="shell-page-head">
          ...
          <div className="shell-page-meta">
            <span>Shift: Production Day</span>
