...
export default function ProductionDashboard() {
  ...
  if (isLoading) return <div style={{ padding: 24, color: '#6b7280' }}>Loading production dashboard…</div>;
  if (error) return <div style={{ padding: 24, color: '#b91c1c' }}>Failed to load production dashboard.</div>;
  if (!data) return null;
